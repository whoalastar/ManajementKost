            ...
            <div class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="account_number" id="account_number" value="{{ old('account_number', $paymentMethod->account_number) }}" required 
                               class="w-full px-4 py-2 border border-gray-200 rounded-xl focus:ring-primary-500 focus:border-primary-500"
                    ...
                    <div>
                        ...
                        <input type="text" name="account_holder" id="account_holder" value="{{ old('account_holder', $paymentMethod->account_holder) }}" required 
                               class="w-full px-4 py-2 border border-gray-200 rounded-xl focus:ring-primary-500 focus:border-primary-500"
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="3" 
                              class="w-full px-4 py-2 border border-gray-200 rounded-xl focus:ring-primary-500 focus:border-primary-500"
                              placeholder="Masukkan instruksi jika ada">{{ old('description', $paymentMethod->description) }}</textarea>
                    ...
                    <div class="flex items-center gap-4">
                        <div class="flex-shrink-0 w-20 h-20 bg-gray-100 rounded-xl flex items-center justify-center border border-gray-200 overflow-hidden" id="logo-preview-container">
                             @if($paymentMethod->logo_url)
                                <img src="{{ $paymentMethod->logo_url }}" class="w-full h-full object-contain">
                             @else
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500">PNG, JPG, GIF up to 2MB. Biarkan kosong jika tidak ingin mengubah logo.</p>
                ...
                <div class="flex items-center">
                    <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $paymentMethod->is_active) ? 'checked' : '' }} class="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded">
